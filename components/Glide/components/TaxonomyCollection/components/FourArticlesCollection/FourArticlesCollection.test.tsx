...
import { FourArticlesCollection } from './FourArticlesCollection';
...
describe('FourArticlesCollection', () => {
    ...
    it('should render correctly FourArticlesCollection', () => {
        ...
        render(<FourArticlesCollection {...props} />)

        expect(screen.getByTestId('Container__FourArticlesCollection')).toBeInTheDocument();
    });
})
